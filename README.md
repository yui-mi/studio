# mystudio
mystudio は、レンタルスタジオの予約ができる予約サイトです。
ユーザーは SNSログインや新規会員登録を行い、カレンダー上の日付をクリックすることで、簡単にスタジオの予約ができます。また、予約済みの日付をクリック することで、予約内容の修正や削除も可能です。
管理者機能として、ユーザーの削除に加え、予約の削除・変更・更新機能 を備えています。
また、お問い合わせ機能を予約サイトに追加することで、ユーザーと管理者が文章でやり取りできる仕組みになっています。
## 機能
### 一般ユーザー向け
